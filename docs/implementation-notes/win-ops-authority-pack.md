...
- Added one repo-local `bun run check` gate covering 19 existing Bun tests, 53 synthetic hook cases, 11 authority-contract checks, and Bash syntax for every hook/operator script. The gate exits 0 locally.
